        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-gold-400/20">
          ...
          <div className="bg-yellow-400/10 p-4 rounded-lg border border-yellow-400/30 mb-8">
            <p className="text-yellow-400 font-medium">
              <strong>Important Notice:</strong> Investoria is currently pre-launch. These terms govern your use of the Investoria website and waitlist today, and your use of the Investoria app and investing features once they become available. By using our service, you agree to these terms.
            </p>
          </div>
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-investoria-muted space-y-2 ml-4">
                ...
                <li>Lets users visualize a stock and ETF portfolio as a building city, where holdings shape the city and buildings level up through XP, achievements, and engagement</li>
                <li>Is designed, at launch, to enable real stock and ETF investing through a partner broker-dealer (this feature is not yet live)</li>
                <li>Offers gamified, city-building experiences to support financial literacy</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-investoria-muted leading-relaxed">
                Once investing is available, investment services will be provided through a partner broker-dealer. Investoria acts as a technology platform and does not provide investment advice or act as a broker-dealer. All investment transactions will be subject to the terms and conditions of the partner broker-dealer.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-investoria-muted leading-relaxed">
                Investoria intends to operate in compliance with applicable securities laws and regulations. At launch, investment services are intended to be provided through a FINRA-registered partner broker-dealer. We reserve the right to restrict access based on regulatory requirements.
              </p>
            </section>
          ...
          <div className="mt-12 pt-8 border-t border-gold-400/30 text-center">
            <p className="text-xs text-investoria-muted/70 leading-relaxed">
              <strong>Securities Disclosure:</strong> Investoria is pre-launch. When available, investment services are intended to be provided through a partner broker-dealer (member FINRA/SIPC). Investoria is not a registered broker-dealer or investment adviser.
            </p>
          </div>
        </div>
      </div>
